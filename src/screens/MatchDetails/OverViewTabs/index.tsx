...
import { RefreshControl, ScrollView, View, Text, FlatList, Image } from 'react-native';
...
import { HeroDetailsModel, MatchDetailsModel, Player } from '../../../../src/services/props';
        ...
        <View style={{ flex: 1, backgroundColor: ColorTheme.light }}>
            ...
            >
                <HeaderComponent
                    ...
                    gameMode={GameMode}
                />
                <TeamsComponent matchDetails={matchDetails} PlayerIdIndex={PlayerIdIndex} />
                {matchDetails &&
